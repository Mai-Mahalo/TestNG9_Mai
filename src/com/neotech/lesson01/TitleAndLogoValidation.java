...
public class TitleAndLogoValidation extends CommonMethods {
	...
	@Test (priority =  -1, enabled = false, groups = "smokes")
	public void titleValidation() {
		...
		if (expectedTitle.equals(actualTitle)) {
			...
			// If you do not do try & catch, the code does not stop it.
		}		
}
	@Test
	...
	public void loginValidation() {
		...
		if(userImg.isDisplayed()) {
			...
			System.out.println("Test failed: User is not logged in our user image is not displayed");
